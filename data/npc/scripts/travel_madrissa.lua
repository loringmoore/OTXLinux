...
-- Basic
keywordHandler:addKeyword({'sail'}, StdModule.say, {npcHandler = npcHandler, text = 'Where do you want to go? To Gravenport, Territh, Crescent Isle, Thunder Cove or Rhymveil?'})
keywordHandler:addKeyword({'passage'}, StdModule.say, {npcHandler = npcHandler, text = 'Where do you want to go? To Gravenport, Territh, Crescent Isle, Thunder Cove or Rhymveil?'})
...
keywordHandler:addKeyword({'madrissa'}, StdModule.say, {npcHandler = npcHandler, text = 'We\'re already there.}'})
