...
-- Basic
keywordHandler:addKeyword({'sail'}, StdModule.say, {npcHandler = npcHandler, text = 'Where do you want to go? To Gravenport, Madrissa, Crescent Isle, Territh or Thunder Cove?'})
keywordHandler:addKeyword({'passage'}, StdModule.say, {npcHandler = npcHandler, text = 'Where do you want to go? To Gravenport, Madrissa, Crescent Isle, Territh or Thunder Cove?'})
keywordHandler:addKeyword({'job'}, StdModule.say, {npcHandler = npcHandler, text = 'I am the captain of this vessel.'})
keywordHandler:addKeyword({'here'}, StdModule.say, {npcHandler = npcHandler, text = 'This is Rhymveil. Where do you want to go?'})
keywordHandler:addKeyword({'rhymveil'}, StdModule.say, {npcHandler = npcHandler, text = 'We\'re already there.}'})
