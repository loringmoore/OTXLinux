...
enum MagicEffectClasses : uint8_t {
	...
	CONST_ME_FIREWORK_YELLOW = 26,
	CONST_ME_FIREWORK_RED = 27,
	CONST_ME_FIREWORK_BLUE = 28,
	CONST_ME_GROUNDSHAKER = 29,
	CONST_ME_FIREATTACK = 30,
	CONST_ME_HOLYAREA = 31,
	CONST_ME_ICEATTACK = 32,
	CONST_ME_ICEAREA = 33,
	CONST_ME_YELLOWENERGY = 34,
	CONST_ME_DICE = 35,
	CONST_ME_BUBBLES = 36,
	CONST_ME_SPLASH = 37,
	CONST_ME_ARCANE = 38,

	CONST_ME_LAST = CONST_ME_ARCANE,
};
...
enum ShootType_t : uint8_t {
	...
	CONST_ANI_POISON = 15,
	CONST_ANI_ENERGYBALL = 16,
	CONST_ANI_INFERNALBOLT = 17,
	CONST_ANI_REDSTAR = 18,
	CONST_ANI_CRYSTALARROW = 19,
	CONST_ANI_HOLY = 20,
	CONST_ANI_SKULL = 21,
	CONST_ANI_ARCANE = 22,
	CONST_ANI_ICE = 23,

	CONST_ANI_LAST = CONST_ANI_ICE,
